...
namespace robustskills {
    ...
    /*
     * An interface for representing an object that can be targeted by other 
     * objects.
     * 
     ...
     *
     *  It's up to you what type of object you would like to use for targeting
     *  data.
     */
    class Targetable
    {
    ...
    /*
     * Provides an interface between targeting assets to enforce a relation.
     * Thereby allows for things to be conditionally targeted.
     */
    ...
    public:
        ...
        /*
         * Can a Targeter with *this* TargetPermissions be allowed to target
         * a Targetable with "otherPermissions"?
         */
        virtual bool canTarget(const TargetPermissions* otherPermissions) const = 0;
    };
